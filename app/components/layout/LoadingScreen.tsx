...
export default function LoadingScreen({
  ...
  useEffect(() => {
    ...
    const loadingTimer = setTimeout(() => {
      setIsLoading(false);
      // Call the completion callback after exit animation
      setTimeout(() => {
        onLoadingComplete?.();
      }, 1500); // Wait for exit animation to complete
  ...
  // Layer animation variants - similar to navbar but on Y-axis
  const primaryLayerVariants = {
    ...
    exit: {
      ...
      transition: {
        duration: 0.9,
        delay: 0.4, // Last to exit (top layer)
        ease: [0.22, 1, 0.36, 1],
      },
    },
  };
  ...
  const tertiaryLayerVariants = {
    ...
    exit: {
      ...
      transition: {
        duration: 0.9,
        delay: 0, // First to exit (bottom layer)
        ease: [0.22, 1, 0.36, 1],
      },
    },
  };
